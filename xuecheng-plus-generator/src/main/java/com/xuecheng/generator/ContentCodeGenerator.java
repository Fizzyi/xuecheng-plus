...
public class ContentCodeGenerator {
    ...
    //数据库账号
    private static final String DATA_SOURCE_USER_NAME = "test";
    //数据库密码
    private static final String DATA_SOURCE_PASSWORD = "qwer1234!";
    //生成的表
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://121.43.238.143:8036/test?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8&allowPublicKeyRetrieval=true");
